...
# @raycast.title Disconnect GlobalProtect
# @raycast.mode silent
...
# Documentation:
# @raycast.description Disconnects the GlobalProtect VPN client.
# @raycast.author Zaid Hammoudi

# This script automates clicking the 'Disconnect' button in the GlobalProtect
...
#   It only sends the click event to the Disconnect button.
...
tell application "System Events"
    tell process "GlobalProtect"
        ...
        # Find and click the "Disconnect" button within the window
        tell window 1
...
echo "GlobalProtect disconnect initiated."
